...
namespace Autotube.Services.All_in_One.Thumbnail.ExternalApis
{

    public class AllStabilityAiService
    {
        private readonly HttpClient _httpClient;
        private readonly ILogger<AllStabilityAiService> _logger;

        private const string EngineId = "stable-diffusion-xl-1024-v1-0";

        public AllStabilityAiService(IHttpClientFactory httpClientFactory,
                                  IConfiguration config,
                                  ILogger<AllStabilityAiService> logger)
        {
