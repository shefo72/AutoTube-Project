...
namespace Autotube.Services.All_in_One.Thumbnail.ExternalApis
{
    ...
    public class AllReplicateService
    {
        private readonly HttpClient _httpClient;
        private readonly ILogger<AllReplicateService> _logger;

        private const string Model =
            "google/imagen-4:19335492dbe879d4b5983bff2149f597db8314ccc7fe374e6313af7c2b52792f";

        public AllReplicateService(IHttpClientFactory httpClientFactory,
                                IConfiguration config,
                                ILogger<AllReplicateService> logger)
        {
